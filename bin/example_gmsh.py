...
parser = argparse.ArgumentParser(description="Imports gmsh .msh files to a mesh, "
                                             ...
                                             "and exports it to either OOFEM or Abaqus.")


requiredNamed = parser.add_argument_group('required named arguments')
requiredNamed.add_argument("-b", "--basefilename", help="The basename of the files, everything before the "
...
if args.output == "abaqus":
    export_to_abaqus(args.basefilename + "_coh.inp", mesh, write_2d_elements=False)
if args.output == "oofem":
    export_to_oofem(args.basefilename + "_coh.in", mesh, write_2d_elements=False)
